<?php
/*
 * Class for handling of shopify API calls. This was downloaded and adapted for payfast.
 * This has been added to the payfast library since this cannot be fetched with composer.
 *
 * Origianl GITHUB Project : https://github.com/cmcdonaldca/ohShopify.php
 *
 * THis librarry was used cause it was being maintained and could be used in both the
 * legacy and Laravel environments as apposed to a Laravel Only one (That does exist)
 *
 * Added by Werner van Ghent <werner.vanghent@payfast.co.za>
 *
 */
...
class ShopifyClient {
    ...
    public function call($method, $path, $params=array())
    {
        ...
        {
            Log::error('Page shopify error: ' . print_r($response,true));
